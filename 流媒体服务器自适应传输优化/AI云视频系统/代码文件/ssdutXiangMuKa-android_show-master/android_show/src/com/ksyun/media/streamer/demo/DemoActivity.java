...
public class DemoActivity extends Activity
    ...
    private ImageButton setBox;
    private LinearLayout settings;
    private boolean isSetting=false;
    private RelativeLayout setBoxParent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a();
        setBox= (ImageButton) findViewById(R.id.set_box);
        settings= (LinearLayout) findViewById(R.id.set_args);
        setBoxParent= (RelativeLayout) findViewById(R.id.set_box_parent);
        initListener();
    ...
    */
            ...
            case R.id.connectBT:
                ...
                if (true) {
                    ...
                    CameraActivity.startActivity(getApplicationContext(), 0,
                            liveUrl, frameRate, videoBitRate,
    ...
    public void initUrl(){
        ...
        String nickName=userInfo.getString("nickName",null);
        if(nickName==null){
            Toast.makeText(DemoActivity.this,"登录过期,请退出后重新登录",Toast.LENGTH_SHORT).show();
            finish();
        }
        liveUrl="rtmp://112.74.182.83/live/"+nickName;
    }

    public void initListener(){
        setBoxParent.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                isSetting=!isSetting;
                if(isSetting){
                    setBox.setBackgroundResource(R.drawable.set_on);
                    settings.setVisibility(View.VISIBLE);
                }else{
                    setBox.setBackgroundResource(R.drawable.set_off);
